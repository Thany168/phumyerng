...
const INITIAL_TEMPLATES = [
  {
    id: 1,
    title: "Elegant Floral Invite",
    category: "Wedding",
    description: "Classic and romantic design, perfect for formal events.",
  },
  {
    id: 2,
    title: "Superhero Birthday Bash",
    category: "Birthday",
    description: "Fun, dynamic design for kids parties and theme events.",
  },
  {
    id: 3,
    title: "Watercolor Baby Shower",
    category: "Baby & Kids",
    description:
      "Adorable blue/pink design for gender reveals or shower invitations.",
  },
  {
    id: 4,
    title: "Modern Cocktail Night",
    category: "Party",
    description: "Stylish and chic template for adult evening events.",
  },
  {
    id: 5,
    title: "Vintage Save The Date",
    category: "Wedding",
    description: "Rustic, minimalist theme with vintage typography.",
  },
  {
    id: 6,
    title: "Sweet Sixteen Banner",
    category: "Birthday",
    description: "Glittering and vibrant design for milestones.",
  },
  {
    id: 7,
    title: "Gender Reveal Balloon",
    category: "Baby & Kids",
    description: "Simple 'He or She' themed design.",
  },
  {
    id: 8,
    title: "Holiday Office Party",
    category: "Party",
    description: "Professional and festive corporate event invite.",
  },
  {
    id: 9,
    title: "Gothic Halloween Rave",
    category: "Party",
    description: "Dark and dramatic invitation for a themed event.",
  },
  {
    id: 10,
    title: "Minimalist Graduation",
    category: "Party",
    description: "Clean design for academic ceremonies.",
  },
];
...
const Home = () => {
  ...
  const categories = useMemo(
    () => ["All", ...new Set(INITIAL_TEMPLATES.map((t) => t.category))],
    []
  );
  ...
  return (
    <div className="space-y-16">
      {/* Hero Section */}
      <section className="bg-linear-to-r from-purple-500 via-pink-500 to-red-400 text-white py-32 px-6 text-center rounded-b-[40px] relative overflow-hidden shadow-xl">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-10 space-y-6 md:space-y-0">
          ...
          <div className="flex flex-wrap justify-center md:justify-end gap-3">
            {categories.map((category) => {
              ...
              const baseClasses =
                "px-6 py-3 rounded-full font-medium transition duration-300 shadow-lg transform hover:scale-105 cursor-pointer";
              let colorClasses = "";
                ...
                colorClasses = isActive
                  ? `${CATEGORY_COLORS[category]
                      ...
                      .replace(
                        "text",
                        "border"
                      )} border-2 border-current font-bold` // Use current color as border for active state
              ...
              >
                ...
                <img
                  ...
                  onError={(e) => {
                    ...
                    e.target.src =
                      "https://placehold.co/400x533/EAEAEA/808080?text=Template+Image";
                  }}
                />
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-4">
                  {/* Category Tag */}
                  <span
                    className={`text-xs font-semibold px-2 py-1 rounded-full w-fit mb-2 ${CATEGORY_COLORS[
                      template.category
                    ]
